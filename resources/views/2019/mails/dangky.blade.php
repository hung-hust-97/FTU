...
<!-- <div style="text-align: center">
    <img src="http://i-invest.sic-ftu.org/2019/logo%20final-02.png" style="max-width: 20%">
</div> -->
<p style="font-weight:bold;">{{$name}} thân mến,</p>

<p>Ban tổ chức <span style="font-weight:bold; color:#188440" >Cuộc thi I-INVEST! 2021</span> xin trân trọng thông báo: bạn đã đăng ký tham gia <span style="font-weight:bold; color:#188440">Vòng 1: I-START!</span> thành công! Dưới đây là thông tin đăng nhập của bạn:</p>

<ul>
    <li style="font-weight:bold;">Tài khoản: {{$email}}</li>
    <li style="font-weight:bold;">Mật khẩu: {{$temp_password}}</li>
</ul>

<p>Hướng dẫn trước khi làm bài:</p>
<ul>
    <li>Bài thi gồm các câu hỏi trắc nghiệm kiểm tra <span style="font-weight:bold; color:#188440">kiến thức về lĩnh vực Kinh tế - Tài chính - Chứng khoán</span> và <span style="font-weight:bold; color:#188440">Năng lực tư duy</span>.</li>
